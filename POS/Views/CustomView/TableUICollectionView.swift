...
class TableUICollectionView : UICollectionView {
    
    enum TableSectionLayoutKind : Int {
        case orderOption
        case table
    ...
    override init(frame: CGRect, collectionViewLayout layout: UICollectionViewLayout) {
        ...
        register(MenuHeaderView.self, forSupplementaryViewOfKind: "Header", withReuseIdentifier: "dsdsdsd")
        configure()
    }
...
//MARK: - UI
extension TableUICollectionView {
...
//        ])
    ...
    class func createLayout() -> UICollectionViewLayout{
        let layout = UICollectionViewCompositionalLayout {
            ...
            guard let layoutKind = TableSectionLayoutKind(rawValue: sectionIndex) else { return nil }
...
@available(iOS 13, *)
struct TableUICollectionView_Preview: PreviewProvider {
    static var previews: some View {
        // view controller using programmatic UI
        TableUICollectionView()
            .getPreview()
